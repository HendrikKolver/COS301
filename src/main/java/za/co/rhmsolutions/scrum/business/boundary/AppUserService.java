...
public class AppUserService 
{
    ...
    public void createUser(String name, String surname, String username,String password)
    {
        ...
        groups g = new groups("user", username);
    }
    ...
    public void updateUser(long id, String name, String surname, String username,String password)
    {
        em.createQuery("UPDATE AppUser a SET a.name='" + name + "', a.surname='"+ surname + "', a.Username='" + username
              + "', a.Password='"+ password + "' WHERE a.id='" + id + "'").executeUpdate();
    }
